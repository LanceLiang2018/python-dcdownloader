...
parser.add_argument('url', metavar='URL', help='target URL', nargs='?', default=None)
...
parser.add_argument('--update', default=False, action='store_true', help='Update comics under this folder if info file exists')